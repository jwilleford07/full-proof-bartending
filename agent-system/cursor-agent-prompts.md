...
Refine Full Proof packages, add-ons, quote language, and bar instant-book framing. Keep base pricing approachable, protect premium perception, and move margin into Full Proof bar rental plus premium add-ons. Do not use discount language.
```
