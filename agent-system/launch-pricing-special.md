...
The founder-led story still matters, but it should support trust rather than discounting.
...
- "Discount bartender."
- "Student pricing."
- Anything that makes Full Proof sound inexperienced.

## Market Read

Full Proof should not price against bare hourly bartender services. The better competitive set is polished mobile bartending and mobile bar service for private events, weddings, corporate events, and brand activations across Los Angeles, Long Beach, South Bay, and Orange County.
...
- Professional tools, bottles, mats, setup, service, cleanup, and composed service flow.
...
**Best fit:** events up to `40` guests that want a polished Full Proof footprint without the larger Elite setup.
...
**Optional for:** smaller events that want the bar to anchor the room visually.

**Why it sells:** higher guest counts need more footprint, more workflow control, and a stronger presentation base.

## Total Wine Guidance + Ice Service

**Price:** `+$100`

Use as the launch friction-killer:
...
Every booked event should create proof:

- Ask for permission to capture short photo/video clips of the bar, ice, and drinks.
- Ask for a Google review within 24 hours after the event.
- Ask for one sentence about what made the service feel easy, polished, or elevated.
- Ask if Full Proof can tag the host or venue when appropriate.

Suggested post-event text:

> Thank you again for having Full Proof. A quick Google review would help a lot while we build the public portfolio. One sentence about the bar setup, drinks, or how easy the hosting felt is perfect.
