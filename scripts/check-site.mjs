...
const requiredFiles = [
  ...
  "assets/photos/full-proof-pro-bar-rental-long-beach.png",
  "assets/photos/full-proof-elite-bar-rental-long-beach.png",
...
const requiredHomepagePatterns = [
  ...
  /\(?949\)?[\s.-]*771[\s.-]*7148/,
  /Check My Date/i,
  /Realistic starting examples/i,
  /Responsible adult service/i,
  /instant-book/i,
  /\$599\s*\/\s*3 hours/i,
  /\$699\s*\/\s*4 hours/i,
  /Full Proof Pro Bar/i,
  /Full Proof Elite Bar/i,
  /Instant-book upgrades/i,
  /ORI ice press/i,
  /premium Tossware/i,
  /dehydrated citrus/i,
